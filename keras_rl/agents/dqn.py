...
from keras_rl.policy import EpsGreedyQPolicy, GreedyQPolicy
from keras_rl.util import *
...
class DQNAgent(AbstractDQNAgent):
    ...
    # Arguments
        ...
        policy__: A Keras-keras_rl policy that are defined in [policy](https://github.com/keras-rl/keras-rl/blob/master/rl/policy.py).
        test_policy__: A Keras-keras_rl policy.
